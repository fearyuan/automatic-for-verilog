...
"	call append(13, "")
	...
	call append(1,  "//////////////////////////////////////////////////////////////////////////////////")
	call append(2,  "// Company: GDUT")
	call append(3,  "// Engineer: fearyuan")
	call append(4,  "// ")
	call append(5,  "// Create Date: ".strftime("%Y-%m-%d %H:%M"))
	call append(6,  "// Design Name: ".filename)
	call append(7,  "// Module Name: ")
	call append(8,  "// Project Name: ")
	call append(9,  "// Taget Devices: ZYNQ-7 ZC706 Evaluation Board (xc7z045ffg900-2)")
	call append(10,  "// Tool Versions: 2018.2")
	call append(11,  "// Description: ")
	call append(12,  "// ")
	call append(13,  "// Dependencies: ")
	call append(14,  "// ")
	call append(15,  "// Revision: ")
	call append(16,  "// Revision 0.01 - File Created")
	call append(17,  "// Additional Comments:")
	call append(18,  "// ")
	call append(19,  "//////////////////////////////////////////////////////////////////////////////////")
	call append(20,  "")
endfunction "}}}2
...
function AutoTemplate() "{{{2
	...
	call AddHeader()
    call append(20, "`ifndef __" . substitute(toupper(filename),'\.','_','') . "__")
    call append(21, "`define __" . substitute(toupper(filename),'\.','_','') . "__")
    call append(22, "")
    call append(23, "`timescale 1ns/1ps")
	call append(24, "")
	call append(25, "module " . modulename . '(/*autoarg*/);')
	if modulename == 'top'
		call append(26, "")
		call append(27, "reg                                     clk;")
		call append(28, "reg                                     rst_n;")
		call append(29, "/*autodef off*/")
		call append(30, "initial begin")
		call append(31, "    clk = 1'b0;")
		call append(32, "    forever #10 clk = ~clk;")
		call append(33, "end")
		call append(34, "initial begin")
		call append(35, "    rst_n = 1'b0;")
		call append(36, "    #52 rst_n = 1'b1;")
		call append(37, "end")
		call append(38, "initial begin")
		call append(39, "    //$vcdpluson(0,top);")
		call append(40, "    $fsdbDumpvars(0,top);")
		call append(41, "end")
		call append(42, "initial begin")
		call append(43, "    #1000;")
		call append(44, "    $finish;")
		call append(45, "end")
		call append(46, "/*autodef on*/")
		call append(47, "")
		call append(48, "//{{{")
		call append(49, '/*autodef*/')
		call append(50, "//}}}")
		call append(51, "")
		call append(52, "//inst u_inst(/*autoinst*/);")
		call append(53, "")
		call append(54, "endmodule")
        call append(55, "")
        call append(56, "`endif")
		call search('inst')
	else
		call append(26, "")
		call append(27, "input                                   clk;")
		call append(28, "input                                   rst_n;")
		call append(29, "")
		call append(30, "input                                   vld;")
		call append(31, "input        [7:0]                      data;")
		call append(32, "output                                  ack;")
		call append(33, "")
		call append(34, "//{{{")
		call append(35, '/*autodef*/')
		call append(36, "//}}}")
		call append(37, "")
		call append(38, "endmodule")
        call append(39, "")
        call append(40, "`endif")
		call search('vld')
	endif
endfunction "}}}2
...
function AutoComment() "{{{2
	...
	if line =~ '^\/\/ by .* \d\d\d\d-\d\d-\d\d'
		...
		let tmp_line = '// by ' . 'fearyuan' . ' ' . strftime("%Y-%m-%d") . ' | ' . line
	endif
...
function AutoComment2() "{{{2
	...
	if line("'<") == lnum || line("'>") == lnum
		if getline(line("'<")) =~ '^/\*'
			...
			call append(line("'<")-1,'/*------\/--------  by '.'fearyuan'.' '.strftime("%Y-%m-%d").'  --------\/--------{{{')
			call append(line("'>")  ,'--------/\--------  by '.'fearyuan'.' '.strftime("%Y-%m-%d").'  --------/\------}}}*/')
			let lnum = line(".")
		endif
	endif
...
function AddCurLineComment() "{{{2
    ...
    let tmp_line = line . ' // ' . 'fearyuan' . ' ' . strftime("%Y-%m-%d") . ' |'
	call setline(lnum,tmp_line)
    normal $
endfunction "}}}2
